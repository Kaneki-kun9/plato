...
unsafe fn font_data_from_script(script: HbScript) -> &'static [libc::c_uchar] {
    match script {
        ...
        | HB_SCRIPT_HAN => include_bytes!("../../../../fonts/DroidSansFallbackFull.ttf"),

        HB_SCRIPT_ARABIC => include_bytes!("../../../../fonts/NotoNaskhArabic[wght].ttf"),
        HB_SCRIPT_SYRIAC => include_bytes!("../../../../fonts/NotoNaskhArabic[wght].ttf"),
        HB_SCRIPT_MEROITIC_CURSIVE | HB_SCRIPT_MEROITIC_HIEROGLYPHS => {
            include_bytes!("../../../../fonts/NotoSansMeroitic-Regular.ttf")
        }

        HB_SCRIPT_ADLAM => include_bytes!("../../../../fonts/NotoSansAdlam-VariableFont_wght.ttf"),
        HB_SCRIPT_AHOM => include_bytes!("../../../../fonts/NotoSerifAhom-Regular.ttf"),
        HB_SCRIPT_ANATOLIAN_HIEROGLYPHS => {
            include_bytes!("../../../../fonts/NotoSansAnatolianHieroglyphs-Regular.ttf")
        }
        HB_SCRIPT_ARMENIAN => include_bytes!("../../../../fonts/NotoSerifArmenian[wght].ttf"),
        HB_SCRIPT_AVESTAN => include_bytes!("../../../../fonts/NotoSansAvestan-Regular.ttf"),
        HB_SCRIPT_BALINESE => {
            include_bytes!("../../../../fonts/NotoSansBalinese-VariableFont_wght.ttf")
        }
        HB_SCRIPT_BAMUM => include_bytes!("../../../../fonts/NotoSansBamum-VariableFont_wght.ttf"),
        HB_SCRIPT_BASSA_VAH => {
            include_bytes!("../../../../fonts/NotoSansBassaVah-VariableFont_wght.ttf")
        }
        HB_SCRIPT_BATAK => include_bytes!("../../../../fonts/NotoSansBatak-Regular.ttf"),
        HB_SCRIPT_BENGALI => include_bytes!("../../../../fonts/NotoSerifBengali[wght].ttf"),
        HB_SCRIPT_BHAIKSUKI => include_bytes!("../../../../fonts/NotoSansBhaiksuki-Regular.ttf"),
        HB_SCRIPT_BRAHMI => include_bytes!("../../../../fonts/NotoSansBrahmi-Regular.ttf"),
        HB_SCRIPT_BUGINESE => include_bytes!("../../../../fonts/NotoSansBuginese-Regular.ttf"),
        HB_SCRIPT_BUHID => include_bytes!("../../../../fonts/NotoSansBuhid-Regular.ttf"),
        HB_SCRIPT_CANADIAN_SYLLABICS => {
            include_bytes!("../../../../fonts/NotoSerifBengali[wght].ttf")
        }
        HB_SCRIPT_CARIAN => include_bytes!("../../../../fonts/NotoSansCarian-Regular.ttf"),
        HB_SCRIPT_CAUCASIAN_ALBANIAN => {
            include_bytes!("../../../../fonts/NotoSansCaucasianAlbanian-Regular.ttf")
        }
        HB_SCRIPT_CHAKMA => include_bytes!("../../../../fonts/NotoSansChakma-Regular.ttf"),
        HB_SCRIPT_CHAM => include_bytes!("../../../../fonts/NotoSansCham-VariableFont_wght.ttf"),
        HB_SCRIPT_CHEROKEE => include_bytes!("../../../../fonts/NotoSansCherokee[wght].ttf"),
        HB_SCRIPT_COPTIC => include_bytes!("../../../../fonts/NotoSansCoptic-Regular.ttf"),
        HB_SCRIPT_CUNEIFORM => include_bytes!("../../../../fonts/NotoSansCuneiform-Regular.ttf"),
        HB_SCRIPT_CYPRIOT => include_bytes!("../../../../fonts/NotoSansCypriot-Regular.ttf"),
        HB_SCRIPT_DESERET => include_bytes!("../../../../fonts/NotoSansDeseret-Regular.ttf"),
        HB_SCRIPT_DEVANAGARI => include_bytes!("../../../../fonts/NotoSerifDevanagari[wght].ttf"),
        HB_SCRIPT_DOGRA => include_bytes!("../../../../fonts/NotoSerifDogra-Regular.ttf"),
        HB_SCRIPT_DUPLOYAN => include_bytes!("../../../../fonts/NotoSansDuployan-Regular.ttf"),
        HB_SCRIPT_EGYPTIAN_HIEROGLYPHS => {
            include_bytes!("../../../../fonts/NotoSansEgyptianHieroglyphs-Regular.ttf")
        }
        HB_SCRIPT_ELBASAN => include_bytes!("../../../../fonts/NotoSansElbasan-Regular.ttf"),
        HB_SCRIPT_ELYMAIC => include_bytes!("../../../../fonts/NotoSansElymaic-Regular.ttf"),
        HB_SCRIPT_ETHIOPIC => include_bytes!("../../../../fonts/NotoSerifEthiopic[wght].ttf"),
        HB_SCRIPT_GEORGIAN => include_bytes!("../../../../fonts/NotoSerifGeorgian[wght].ttf"),
        HB_SCRIPT_GLAGOLITIC => include_bytes!("../../../../fonts/NotoSansGlagolitic-Regular.ttf"),
        HB_SCRIPT_GOTHIC => include_bytes!("../../../../fonts/NotoSansGothic-Regular.ttf"),
        HB_SCRIPT_GRANTHA => include_bytes!("../../../../fonts/NotoSansGrantha-Regular.ttf"),
        HB_SCRIPT_GUJARATI => include_bytes!("../../../../fonts/NotoSerifGujarati[wght].ttf"),
        HB_SCRIPT_GUNJALA_GONDI => {
            include_bytes!("../../../../fonts/NotoSansGunjalaGondi-VariableFont_wght.ttf")
        }
        HB_SCRIPT_GURMUKHI => include_bytes!("../../../../fonts/NotoSerifGurmukhi[wght].ttf"),
        HB_SCRIPT_HANIFI_ROHINGYA => {
            include_bytes!("../../../../fonts/NotoSansHanifiRohingya-VariableFont_wght.ttf")
        }
        HB_SCRIPT_HANUNOO => include_bytes!("../../../../fonts/NotoSansHanunoo-Regular.ttf"),
        HB_SCRIPT_HATRAN => include_bytes!("../../../../fonts/NotoSansHatran-Regular.ttf"),
        HB_SCRIPT_HEBREW => include_bytes!("../../../../fonts/NotoSerifHebrew[wght].ttf"),
        HB_SCRIPT_IMPERIAL_ARAMAIC => {
            include_bytes!("../../../../fonts/NotoSansImperialAramaic-Regular.ttf")
        }
        HB_SCRIPT_INSCRIPTIONAL_PAHLAVI => {
            include_bytes!("../../../../fonts/NotoSansInscriptionalPahlavi-Regular.ttf")
        }
        HB_SCRIPT_INSCRIPTIONAL_PARTHIAN => {
            include_bytes!("../../../../fonts/NotoSansInscriptionalParthian-Regular.ttf")
        }
        HB_SCRIPT_JAVANESE => {
            include_bytes!("../../../../fonts/NotoSansJavanese-VariableFont_wght.ttf")
        }
        HB_SCRIPT_KAITHI => include_bytes!("../../../../fonts/NotoSansKaithi-Regular.ttf"),
        HB_SCRIPT_KANNADA => {
            include_bytes!("../../../../fonts/NotoSansKannada-VariableFont_wdth,wght.ttf")
        }
        HB_SCRIPT_KAYAH_LI => {
            include_bytes!("../../../../fonts/NotoSansKayahLi-VariableFont_wght.ttf")
        }
        HB_SCRIPT_KHAROSHTHI => include_bytes!("../../../../fonts/NotoSansKharoshthi-Regular.ttf"),
        HB_SCRIPT_KHMER => include_bytes!("../../../../fonts/Khmer-Regular.ttf"),
        HB_SCRIPT_KHOJKI => include_bytes!("../../../../fonts/NotoSansKhojki-Regular.ttf"),
        HB_SCRIPT_KHUDAWADI => include_bytes!("../../../../fonts/NotoSansKhudawadi-Regular.ttf"),
        HB_SCRIPT_LAO => include_bytes!("../../../../fonts/NotoSansLao-VariableFont_wdth,wght.ttf"),
        HB_SCRIPT_LEPCHA => include_bytes!("../../../../fonts/NotoSansLepcha-Regular.ttf"),
        HB_SCRIPT_LIMBU => include_bytes!("../../../../fonts/NotoSansLimbu-Regular.ttf"),
        HB_SCRIPT_LINEAR_A => include_bytes!("../../../../fonts/NotoSansLinearA-Regular.ttf"),
        HB_SCRIPT_LINEAR_B => include_bytes!("../../../../fonts/NotoSansLinearB-Regular.ttf"),
        HB_SCRIPT_LISU => include_bytes!("../../../../fonts/NotoSansLisu-VariableFont_wght.ttf"),
        HB_SCRIPT_LYCIAN => include_bytes!("../../../../fonts/NotoSansLycian-Regular.ttf"),
        HB_SCRIPT_LYDIAN => include_bytes!("../../../../fonts/NotoSansLydian-Regular.ttf"),
        HB_SCRIPT_MAHAJANI => include_bytes!("../../../../fonts/NotoSansMahajani-Regular.ttf"),
        HB_SCRIPT_MALAYALAM => {
            include_bytes!("../../../../fonts/NotoSansMalayalam-VariableFont_wdth,wght.ttf")
        }
        HB_SCRIPT_MANDAIC => include_bytes!("../../../../fonts/NotoSansMandaic-Regular.ttf"),
        HB_SCRIPT_MANICHAEAN => include_bytes!("../../../../fonts/NotoSansManichaean-Regular.ttf"),
        HB_SCRIPT_MARCHEN => include_bytes!("../../../../fonts/NotoSansMarchen-Regular.ttf"),
        HB_SCRIPT_MASARAM_GONDI => {
            include_bytes!("../../../../fonts/NotoSansMasaramGondi-Regular.ttf")
        }
        HB_SCRIPT_MEDEFAIDRIN => {
            include_bytes!("../../../../fonts/NotoSansMedefaidrin-VariableFont_wght.ttf")
        }
        HB_SCRIPT_MEETEI_MAYEK => {
            include_bytes!("../../../../fonts/NotoSansMeeteiMayek-VariableFont_wght.ttf")
        }
        HB_SCRIPT_MENDE_KIKAKUI => {
            include_bytes!("../../../../fonts/NotoSansMendeKikakui-Regular.ttf")
        }
        HB_SCRIPT_MIAO => include_bytes!("../../../../fonts/NotoSansMiao-Regular.ttf"),
        HB_SCRIPT_MODI => include_bytes!("../../../../fonts/NotoSansModi-Regular.ttf"),
        HB_SCRIPT_MONGOLIAN => include_bytes!("../../../../fonts/NotoSansMongolian-Regular.ttf"),
        HB_SCRIPT_MRO => include_bytes!("../../../../fonts/NotoSansMro-Regular.ttf"),
        HB_SCRIPT_MULTANI => include_bytes!("../../../../fonts/NotoSansMultani-Regular.ttf"),
        HB_SCRIPT_MYANMAR => include_bytes!("../../../../fonts/NotoSansMyanmar-Regular.ttf"),
        HB_SCRIPT_NABATAEAN => include_bytes!("../../../../fonts/NotoSansNabataean-Regular.ttf"),
        HB_SCRIPT_NEWA => include_bytes!("../../../../fonts/NotoSansNewa-Regular.ttf"),
        HB_SCRIPT_NEW_TAI_LUE => {
            include_bytes!("../../../../fonts/NotoSansNewTaiLue-VariableFont_wght.ttf")
        }
        HB_SCRIPT_NKO => include_bytes!("../../../../fonts/NotoSansNKo-Regular.ttf"),
        HB_SCRIPT_NUSHU => include_bytes!("../../../../fonts/NotoSansNushu-Regular.ttf"),
        HB_SCRIPT_NYIAKENG_PUACHUE_HMONG => {
            include_bytes!("../../../../fonts/NotoSerifNPHmong-VariableFont_wght.ttf")
        }
        HB_SCRIPT_OGHAM => include_bytes!("../../../../fonts/NotoSansOgham-Regular.ttf"),
        HB_SCRIPT_OLD_HUNGARIAN => {
            include_bytes!("../../../../fonts/NotoSansOldHungarian-Regular.ttf")
        }
        HB_SCRIPT_OLD_ITALIC => include_bytes!("../../../../fonts/NotoSansOldItalic-Regular.ttf"),
        HB_SCRIPT_OLD_NORTH_ARABIAN => {
            include_bytes!("../../../../fonts/NotoSansOldNorthArabian-Regular.ttf")
        }
        HB_SCRIPT_OLD_PERMIC => include_bytes!("../../../../fonts/NotoSansOldPermic-Regular.ttf"),
        HB_SCRIPT_OLD_PERSIAN => include_bytes!("../../../../fonts/NotoSansOldPersian-Regular.ttf"),
        HB_SCRIPT_OLD_SOGDIAN => include_bytes!("../../../../fonts/NotoSansOldSogdian-Regular.ttf"),
        HB_SCRIPT_OLD_SOUTH_ARABIAN => {
            include_bytes!("../../../../fonts/NotoSansOldSouthArabian-Regular.ttf")
        }
        HB_SCRIPT_OLD_TURKIC => include_bytes!("../../../../fonts/NotoSansOldTurkic-Regular.ttf"),
        HB_SCRIPT_OL_CHIKI => {
            include_bytes!("../../../../fonts/NotoSansOlChiki-VariableFont_wght.ttf")
        }
        HB_SCRIPT_ORIYA => include_bytes!("../../../../fonts/NotoSansOriya[wght].ttf"),
        HB_SCRIPT_OSAGE => include_bytes!("../../../../fonts/NotoSansOsage-Regular.ttf"),
        HB_SCRIPT_OSMANYA => include_bytes!("../../../../fonts/NotoSansOsmanya-Regular.ttf"),
        HB_SCRIPT_PAHAWH_HMONG => {
            include_bytes!("../../../../fonts/NotoSansPahawhHmong-Regular.ttf")
        }
        HB_SCRIPT_PALMYRENE => include_bytes!("../../../../fonts/NotoSansPalmyrene-Regular.ttf"),
        HB_SCRIPT_PAU_CIN_HAU => include_bytes!("../../../../fonts/NotoSansPauCinHau-Regular.ttf"),
        HB_SCRIPT_PHAGS_PA => include_bytes!("../../../../fonts/NotoSansPhagsPa-Regular.ttf"),
        HB_SCRIPT_PHOENICIAN => include_bytes!("../../../../fonts/NotoSansPhoenician-Regular.ttf"),
        HB_SCRIPT_PSALTER_PAHLAVI => {
            include_bytes!("../../../../fonts/NotoSansPsalterPahlavi-Regular.ttf")
        }
        HB_SCRIPT_REJANG => include_bytes!("../../../../fonts/NotoSansRejang-Regular.ttf"),
        HB_SCRIPT_RUNIC => include_bytes!("../../../../fonts/NotoSansRunic-Regular.ttf"),
        HB_SCRIPT_SAMARITAN => include_bytes!("../../../../fonts/NotoSansSamaritan-Regular.ttf"),
        HB_SCRIPT_SAURASHTRA => include_bytes!("../../../../fonts/NotoSansSaurashtra-Regular.ttf"),
        HB_SCRIPT_SHARADA => include_bytes!("../../../../fonts/NotoSansSharada-Regular.ttf"),
        HB_SCRIPT_SHAVIAN => include_bytes!("../../../../fonts/NotoSansShavian-Regular.ttf"),
        HB_SCRIPT_SIDDHAM => include_bytes!("../../../../fonts/NotoSansSiddham-Regular.ttf"),
        HB_SCRIPT_SINHALA => {
            include_bytes!("../../../../fonts/NotoSansSinhala-VariableFont_wdth,wght.ttf")
        }
        HB_SCRIPT_SOGDIAN => include_bytes!("../../../../fonts/NotoSansSogdian-Regular.ttf"),
        HB_SCRIPT_SORA_SOMPENG => {
            include_bytes!("../../../../fonts/NotoSansSoraSompeng-VariableFont_wght.ttf")
        }
        HB_SCRIPT_SOYOMBO => include_bytes!("../../../../fonts/NotoSansSoyombo-Regular.ttf"),
        HB_SCRIPT_SUNDANESE => {
            include_bytes!("../../../../fonts/NotoSansSundanese-VariableFont_wght.ttf")
        }
        HB_SCRIPT_SYLOTI_NAGRI => {
            include_bytes!("../../../../fonts/NotoSansSylotiNagri-Regular.ttf")
        }
        HB_SCRIPT_TAGALOG => include_bytes!("../../../../fonts/NotoSansTagalog-Regular.ttf"),
        HB_SCRIPT_TAGBANWA => include_bytes!("../../../../fonts/NotoSansTagbanwa-Regular.ttf"),
        HB_SCRIPT_TAI_LE => include_bytes!("../../../../fonts/NotoSansTaiLe-Regular.ttf"),
        HB_SCRIPT_TAI_THAM => {
            include_bytes!("../../../../fonts/NotoSansTaiTham-VariableFont_wght.ttf")
        }
        HB_SCRIPT_TAI_VIET => include_bytes!("../../../../fonts/NotoSansTaiViet-Regular.ttf"),
        HB_SCRIPT_TAKRI => include_bytes!("../../../../fonts/NotoSansTakri-Regular.ttf"),
        HB_SCRIPT_TAMIL => {
            include_bytes!("../../../../fonts/NotoSansTamil-VariableFont_wdth,wght.ttf")
        }
        HB_SCRIPT_TELUGU => {
            include_bytes!("../../../../fonts/NotoSansTelugu-VariableFont_wdth,wght.ttf")
        }
        HB_SCRIPT_THAANA => {
            include_bytes!("../../../../fonts/NotoSansThaana-VariableFont_wght.ttf")
        }
        HB_SCRIPT_THAI => {
        ...
        HB_SCRIPT_TIFINAGH => include_bytes!("../../../../fonts/NotoSansTifinagh-Regular.ttf"),
        HB_SCRIPT_TIRHUTA => include_bytes!("../../../../fonts/NotoSansTirhuta-Regular.ttf"),
        HB_SCRIPT_UGARITIC => include_bytes!("../../../../fonts/NotoSansUgaritic-Regular.ttf"),
        HB_SCRIPT_VAI => include_bytes!("../../../../fonts/NotoSansVai-Regular.ttf"),
        HB_SCRIPT_WANCHO => include_bytes!("../../../../fonts/NotoSansWancho-Regular.ttf"),
        HB_SCRIPT_WARANG_CITI => include_bytes!("../../../../fonts/NotoSansWarangCiti-Regular.ttf"),
        HB_SCRIPT_YEZIDI => {
            include_bytes!("../../../../fonts/NotoSerifYezidi-VariableFont_wght.ttf")
        }
        HB_SCRIPT_YI => include_bytes!("../../../../fonts/NotoSansYi-Regular.ttf"),
        HB_SCRIPT_ZANABAZAR_SQUARE => {
            include_bytes!("../../../../fonts/NotoSansZanabazarSquare-Regular.ttf")
        }

        HB_SYMBOL_MATHS => include_bytes!("../../../../fonts/NotoSansMath-Regular.ttf"),
        HB_SYMBOL_MUSIC => include_bytes!("../../../../fonts/NotoMusic-Regular.ttf"),
        HB_SYMBOL_MISC_ONE => {
            include_bytes!("../../../../fonts/NotoSansSymbols-VariableFont_wght.ttf")
        }
        HB_SCRIPT_BRAILLE | HB_SYMBOL_MISC_TWO => {
            include_bytes!("../../../../fonts/NotoSansSymbols2-Regular.ttf")
        }
        HB_SYMBOL_EMOJI => include_bytes!("../../../../fonts/NotoEmoji-VariableFont_wght.ttf"),

        _ => include_bytes!("../../../../fonts/DroidSansFallbackFull.ttf"),
    }
}
